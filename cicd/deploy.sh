...
## 获取最新的制品的名称
artifact_name="$(ls -t ./target/*-2.0.0.jar | head -n 1 | awk -F '/' '{print $3}')"
...
sudo su -
mv /tmp/$artifact_name /home/taibiex-private-api-v2
cd /home/taibiex-private-api-v2
ps -aux | grep $artifact_name | grep -v grep | awk '{print \$2}' | xargs -I _ kill -9 _
